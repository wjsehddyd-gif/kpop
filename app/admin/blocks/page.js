...
const AREAS = [{"area": "베이스 · 피부", "steps": [{"key": "base", "label": "베이스", "tierKo": "필수", "tierCls": "t-core", "tools": ["쿠션·파운데이션", "컨실러", "파우더"], "spots": [{"l": "피부 전체", "w": "이마·볼·코·턱", "c": ""}, {"l": "붉은기", "w": "코·볼 안쪽 정리", "c": "lilac"}], "tip": {"w": "피부톤을 고르게 정리해 메이크업이 잘 받는 바탕을 만들기 위해", "l": "이마·볼·코·턱 등 얼굴 전체", "m": "한 번에 두껍게 바르면 들뜨고 갈라져요 — 얇게 여러 번"}, "generic": null, "variants": [{"v": "세미매트~글로우", "who": ["카리나"]}, {"v": "글로우 피부", "who": ["윈터"]}, {"v": "글로시 피부", "who": ["제니"]}, {"v": "화사한 피부", "who": ["장원영"]}, {"v": "깨끗한 피부", "who": ["안유진"]}, {"v": "맑은 피부", "who": ["아이유"]}], "hasBlock": true}, {"key": "blush", "label": "블러셔", "tierKo": "주요", "tierCls": "t-major", "tools": ["블러셔"], "spots": [{"l": "볼", "w": "광대 위쪽", "c": "lilac"}], "tip": {"w": "혈색을 더해 화사하고 건강해 보이게 하려고", "l": "미소 지을 때 도톰해지는 볼", "m": "진하게 한 번에 올리면 부담스러워요 — 소량씩"}, "generic": null, "variants": [{"v": "은은한 로즈", "who": ["카리나"]}, {"v": "코랄 블러셔", "who": ["윈터", "안유진"]}, {"v": "로즈브라운", "who": ["제니"]}, {"v": "핑크 애플", "who": ["장원영"]}, {"v": "누드핑크", "who": ["아이유"]}], "hasBlock": true}]}, {"area": "눈썹", "steps": [{"key": "brow", "label": "눈썹", "tierKo": "필수", "tierCls": "t-core", "tools": ["브로우 펜슬", "브로우 마스카라"], "spots": [{"l": "눈썹 앞", "w": "코쪽 눈썹 머리", "c": ""}, {"l": "눈썹 꼬리", "w": "관자쪽 눈썹 끝", "c": "lilac"}], "tip": {"w": "눈썹은 얼굴의 인상과 분위기를 결정해서", "l": "눈썹 앞머리부터 꼬리까지", "m": "앞머리를 진하게 채우면 부자연스러워요 — 앞은 연하게, 꼬리만"}, "generic": null, "variants": [{"v": "각진 일자 눈썹", "who": ["카리나"]}, {"v": "자연 일자 눈썹", "who": ["윈터"]}, {"v": "또렷한 눈썹", "who": ["제니"]}, {"v": "자연 둥근 눈썹", "who": ["장원영"]}, {"v": "자연 눈썹", "who": ["안유진"]}, {"v": "자연 결 눈썹", "who": ["아이유"]}], "hasBlock": true}]}, {"area": "눈 화장", "steps": [{"key": "shadow", "label": "아이섀도우", "tierKo": "주요", "tierCls": "t-major", "tools": ["아이섀도우 팔레트"], "spots": [{"l": "눈두덩", "w": "베이스 섀도우", "c": "lilac"}, {"l": "눈꼬리", "w": "포인트 섀도우", "c": "pink"}], "tip": {"w": "눈매에 음영과 깊이를 더해 입체감을 주려고", "l": "눈두덩 전체와 눈꼬리", "m": "진한 색을 먼저 올리면 탁해져요 — 연한 색부터 조금씩"}, "generic": null, "variants": [{"v": "브라운 음영 섀도우", "who": ["카리나"]}, {"v": "코랄브라운 섀도우", "who": ["윈터"]}, {"v": "브라운 스모키", "who": ["제니"]}, {"v": "핑크/코랄 섀도우", "who": ["장원영"]}, {"v": "코랄핑크 섀도우", "who": ["안유진"]}, {"v": "누드/코랄 섀도우", "who": ["아이유"]}], "hasBlock": true}, {"key": "eyeliner", "label": "아이라인", "tierKo": "조건부", "tierCls": "t-cond", "tools": ["아이라이너"], "spots": [{"l": "아이라인", "w": "속눈썹 라인~눈꼬리", "c": "pink"}, {"l": "언더", "w": "눈꼬리 아래 1/3", "c": "pink"}], "tip": {"w": "눈을 더 길고 또렷하게 보이게 하려고", "l": "속눈썹 사이와 눈꼬리 바깥쪽", "m": "너무 길게 빼면 처져 보여요 — 눈꼬리에서 2~3mm만"}, "generic": null, "variants": [{"v": "또렷한 슬림 윙 라인", "who": ["카리나"]}, {"v": "또렷하되 부드러운 라인", "who": ["윈터"]}, {"v": "스모키 라인", "who": ["제니"]}, {"v": "또렷+러블리 라인", "who": ["장원영"]}, {"v": "또렷한 라인", "who": ["안유진"]}, {"v": "옅은 자연 라인", "who": ["아이유"]}], "hasBlock": true}, {"key": "aegyo", "label": "애교살", "tierKo": "조건부", "tierCls": "t-cond", "tools": ["애교살 섀도우"], "spots": [{"l": "애교살", "w": "눈 밑 도톰한 부분", "c": "lilac"}], "tip": {"w": "눈 밑을 도톰하게 보여 생기와 애교를 더하려고", "l": "웃을 때 도톰해지는 눈 밑", "m": "너무 넓게 바르면 부어 보여요 — 얇은 띠로만"}, "generic": null, "variants": [{"v": "은은한 애교살", "who": ["카리나", "제니"]}, {"v": "애교살 살짝", "who": ["윈터"]}, {"v": "애교살 밝게", "who": ["장원영"]}, {"v": "애교살 강조", "who": ["안유진"]}, {"v": "애교살 자연", "who": ["아이유"]}], "hasBlock": true}, {"key": "lash", "label": "속눈썹", "tierKo": "조건부", "tierCls": "t-cond", "tools": ["뷰러", "마스카라"], "spots": [{"l": "속눈썹", "w": "눈 위 전체", "c": "pink"}], "tip": {"w": "속눈썹을 올려 눈을 또렷하고 커 보이게 하려고", "l": "위 속눈썹 전체", "m": "마스카라가 뭉치면 지저분해요 — 빗으로 정리"}, "generic": ["뷰러로 속눈썹 뿌리부터 컬링", "마스카라 지그재그로 올리기", "뭉친 부분 빗으로 정리"], "variants": [], "hasBlock": false}]}, {"area": "윤곽 · 입체", "steps": [{"key": "contour", "label": "쉐딩", "tierKo": "조건부", "tierCls": "t-cond", "tools": ["쉐딩 파우더"], "spots": [{"l": "턱선 음영", "w": "턱끝~귀밑 사선", "c": "pink"}, {"l": "턱끝 하이라이트", "w": "턱 가운데 끝", "c": "lilac"}], "tip": {"w": "얼굴에 음영을 줘 갸름하고 입체감 있게 보이려고", "l": "턱선 사선과 광대 아래", "m": "경계가 선명하면 얼룩져 보여요 — 충분히 블렌딩"}, "generic": null, "variants": [{"v": "광대 아래·턱선 윤곽", "who": ["카리나"]}, {"v": "약한 윤곽", "who": ["윈터", "장원영", "안유진"]}, {"v": "윤곽 강조", "who": ["제니"]}, {"v": "최소 윤곽", "who": ["아이유"]}], "hasBlock": true}, {"key": "highlight", "label": "하이라이터", "tierKo": "추가", "tierCls": "t-extra", "tools": ["하이라이터"], "spots": [{"l": "하이라이트", "w": "콧대·광대·턱끝", "c": "lilac"}], "tip": {"w": "높은 부위에 광을 줘 입체감을 살리려고", "l": "콧대·광대 위·턱끝", "m": "너무 넓게 바르면 번들거려요 — 좁게 포인트만"}, "generic": ["콧대·광대 위에 하이라이트", "눈 밑 세모존 살짝", "경계 톡톡 블렌딩"], "variants": [], "hasBlock": false}]}, {"area": "립", "steps": [{"key": "lip", "label": "립", "tierKo": "필수", "tierCls": "t-core", "tools": ["립 제품"], "spots": [{"l": "립 중앙", "w": "입술 가운데 밝게", "c": "pink"}, {"l": "립 외곽", "w": "입술 경계 정리", "c": "lilac"}], "tip": {"w": "전체 메이크업의 포인트와 분위기를 완성하려고", "l": "입술 전체, 중앙은 더 밝게", "m": "각질 위에 바르면 갈라져 보여요 — 정돈 먼저"}, "generic": null, "variants": [{"v": "로즈~누드 새틴", "who": ["카리나"]}, {"v": "MLBB 코랄", "who": ["윈터"]}, {"v": "글로시 누드~로즈", "who": ["제니"]}, {"v": "핑크 그라데이션", "who": ["장원영"]}, {"v": "화사한 코랄", "who": ["안유진"]}, {"v": "MLBB~코랄 틴트", "who": ["아이유"]}], "hasBlock": true}]}, {"area": "헤어", "steps": [{"key": "hair", "label": "헤어", "tierKo": "필수", "tierCls": "t-core", "tools": ["헤어 제품(고데기·왁스)"], "spots": [{"l": "가르마", "w": "정수리 가르마 라인", "c": ""}, {"l": "얼굴 라인", "w": "양쪽 옆머리", "c": "lilac"}], "tip": {"w": "스타일의 분위기를 최종적으로 완성하려고", "l": "가르마·앞머리·얼굴 옆 라인", "m": "모근이 눌리면 밋밋해요 — 뿌리 볼륨부터"}, "generic": null, "variants": [{"v": "슬릭/웨이브", "who": ["카리나"]}, {"v": "자연 결", "who": ["윈터"]}, {"v": "뱅/웨이브", "who": ["제니"]}, {"v": "롱 웨이브", "who": ["장원영"]}, {"v": "단정한 스타일", "who": ["안유진"]}, {"v": "단아한 스타일", "who": ["아이유"]}], "hasBlock": true}]}];
