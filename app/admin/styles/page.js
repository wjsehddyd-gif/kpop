...
const DEX = [
  { name: "카리나", mood: "시크 · 도시적", g: ["#3B5BFE", "#9C6BFF"], base: "매트 글로우 베이스", eye: "브라운 스모키 + 언더 펄", lip: "MLBB 로즈 브라운", hair: "롱 웨이브", tags: ["쿨톤", "고양이상", "스모키"], set: "카리나_VLINE_01" },
  { name: "윈터", mood: "청순 · 시크", g: ["#5C7CFA", "#3B5BFE"], base: "촉촉 글로우 베이스", eye: "코랄 브라운 + 또렷 라인", lip: "코랄 누드", hair: "레이어드 단발", tags: ["뉴트럴", "또렷눈매", "청순"], set: "윈터_OVAL_01" },
  { name: "제니", mood: "걸크러시 · 무드", g: ["#26C6A6", "#3B5BFE"], base: "세미매트 베이스", eye: "버건디 그라데이션", lip: "버건디 레드", hair: "풀뱅 웨이브", tags: ["쿨톤", "강렬", "무드"], set: "제니_HEART_01" },
  { name: "장원영", mood: "러블리 · 화사", g: ["#9C6BFF", "#FF8DC7"], base: "광채 글로우 베이스", eye: "핑크 펄 + 애교살", lip: "핑크 글로스", hair: "긴 생머리", tags: ["봄웜", "러블리", "글로우"], set: "장원영_OVAL_01" },
  { name: "안유진", mood: "청량 · 상큼", g: ["#F59E0B", "#FF8DC7"], base: "내추럴 베이스", eye: "피치 코랄 + 자연 라인", lip: "코랄 틴트", hair: "긴 웨이브", tags: ["웜톤", "청량", "내추럴"], set: "안유진_HEART_01" },
  { name: "아이유", mood: "내추럴 · 단아", g: ["#94A3B8", "#9C6BFF"], base: "은은한 광 베이스", eye: "로즈 브라운 + 옅은 라인", lip: "로즈 누드", hair: "단정 웨이브", tags: ["뉴트럴", "단아", "데일리"], set: "아이유_OVAL_01" },
];
